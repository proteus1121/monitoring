...
public class LightConsumer implements MeasurementConsumer {
    ...
    public String getTopic() {
        return DeviceType.LIGHT.getTopic();
    }
    ...
    public void processMessage(String message) {
        ...
        sensorDataRepository.save(sensorDataMapper.toSensorDataEntity(value, 7L));
    }
}
